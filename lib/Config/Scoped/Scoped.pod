...
Convince Damian Conway to apply the C<P::RD> patch in the next
release. The patch is used in this package to enable inheritance for
...
distribution. I sent the patch to Damian but didn't get a reply. This
